...
The `sd_show_if()` function can also be used to conditionally display a page. In this example, if you choose "**Cat**" in the question below, you'll be directed to a cat-related page, and same for the "**Dog**" selection. No matter which option you choose, you won't see the other page.

The flow chart below illustrates how the conditional page display works:
